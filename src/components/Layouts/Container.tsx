...
const Container = (props: ContainerType) => {
  return (
    <>
      <ModalStore />
      <Navbar />
      <main className="container flex h-dvh max-w-full justify-between gap-5 overflow-y-auto p-5 pt-20 max-[690px]:gap-3 max-[690px]:px-3 max-[460px]:px-0 max-[460px]:pt-16">
        <AsideLeft />
        <div className="mx-auto flex min-[460px]:gap-3 min-w-[35rem] max-w-min flex-col max-[690px]:min-w-[30rem] max-[510px]:min-w-[27rem] max-[460px]:min-w-full">
